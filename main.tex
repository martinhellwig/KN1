...
\section{Kommunikationsabl\"aufe}
Das PPP eignet sich f\"ur die \"Ubertragung \"uber einer Vielzahl an Physical Layer Protokollen.
Hierzu z\"ahlen unter anderem  Synchronous Optical Network (SONET), GPRS-/UMTS oder auch
die weit verbeitete PPPoE-Variante in Verbindung mit Direct Subscriber Line (DSL) Anschl\"ussen\cite{IEEEhowto:kopka}.
An dieser Stelle wird exemplarisch der Kommunikationsablauf anhand von PPPoE aufgezeigt.
\subsection{PPP over Ethernet}
Dass PPPoE Protokoll ist in RFC 2516 spezifiziert \cite{RFC2516} und erm\"oglicht die \"Ubertragung
von Ethernet-Rahmen \"uber eine PPP-Verbindung.
Diese ermöglicht die Kombination der Authentifizierungsfunktionen von PPP mit den
Simultanen Zugriffsmöglichkeiten des Ethernet. Weitere Vorteile sind die Ermöglichung
von Breitbandzugängen für viele DSL-Anschlüsse, Wireless-Zugängen oder Kabelmodems sowie
Kompatibiliät mit allen exisitieren DSL-Modems.\\
%
...
%
Die Bedeutung der PPPoE und PPP header ist in Tabelle \ref{tab:PPPoE_fields} dargestellt.
%
\begin{tabular}{|l|p{6.5cm}|}
\hline 
Ver & Verwendete Version des PPPoE \\ 
\hline 
Type & Verwendeter Typ des PPPoE  \\ 
\hline 
...
\end{tabular} 
%
Der Ablauf einer PPPoE Session kann in die drei Phasen Discovery, Session und Terminate aufgteilt werden.
Diese werden in Abbildung in den folgenden Abschnitten näher erläutert.
\begin{figure}[h!]
 \centering
