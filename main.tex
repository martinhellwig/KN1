...
Phase PPP-spezifisch und in Abbildung \ref{fig:ppp_startnetworks} und \ref{ppp_oracle_ablauf} genauer dargestellt.
%
\begin{figure}[h!]
 \centering
...
\begin{figure}[h!]
 \centering
  \includegraphics[width=0.4\textwidth]{img/ppp_linkstates2.png}
